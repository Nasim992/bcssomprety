...
if(isset($_POST['delete_model_test'])){
...
$deleteSuccess=false;
    ...
    if($deleteSuccess){
        set_message('<div class="container p-2">
          <p class="alert alert-success alert-dismissible" id="message">Model Test Deleted Successfully</p>
        </div>');
        redirect('../admin/view_model_tests');
      }else{
          set_message('<div class="container p-2">
