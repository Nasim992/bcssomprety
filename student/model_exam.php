...
<div class="container">
    ...
    <hr>             
                        <script>
                        TargetDate = "<?php echo $row['model_test_date']; ?>";
                        BackColor = "yellow";
                        ForeColor = "navy";
                        CountActive = true;
                        CountStepper = -1;
                        LeadingZero = true;
                        DisplayFormat = "%%D%% দিন, %%H%% ঘন্টা, %%M%% মিনিট, %%S%% সেকেন্ড.";
                        FinishMessage = "<button class='start_exam_btn form-control btn btn-success'>Start Exam</button>";
                      </script>
