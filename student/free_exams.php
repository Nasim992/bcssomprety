...
// For Pagination 
$results_per_page = 10;  
$total_number_of_results = TotalNumberOfRowsWhereTWO_AND($MODEL_TEST,'payment','finished',1,1);
...
<div class="container">
    ...
    <div class="row">
        ...
        <a class="exam_type_btn active" href="free_exams">Free Exam</a>
